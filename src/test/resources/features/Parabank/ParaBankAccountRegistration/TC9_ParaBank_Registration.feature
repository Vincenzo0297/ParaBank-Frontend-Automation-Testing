Feature: TC9_Registration Form Test

  @web @TC9_PARABANK_Registration
  Scenario Outline: Successful User Registration
    ...
    Then User sign up for ParaBank Account
      | TC-9-Register-Firstname  |
      | TC-9-Register-Lastname   |
      | TC-9-Register-Address    |
      | TC-9-Register-City       |
      | TC-9-Register-State      |
      | TC-9-Register-ZipCode    |
      | TC-9-Register-Phone      |
      | TC-9-Register-SSN        |
    ...
    Examples:
      ...
      | TC-9-UserName | TC-9-Password  |  TC-9-Account-Username  |  TC-9-Account-Password   | TC-9-Account-ConfirmPassword  |
